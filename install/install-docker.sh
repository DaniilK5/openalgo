...
validate_broker() {
    local broker=$1
    local valid_brokers="fivepaisa,fivepaisaxts,aliceblue,angel,arrow,bybit,compositedge,definedge,deltaexchange,dhan,dhan_sandbox,firstock,flattrade,fyers,groww,hdfcsecurities,hdfcsky,ibulls,iifl,iiflcapital,indmoney,jainamxts,kotak,motilal,mstock,nubra,paytm,pocketful,rmoney,samco,shoonya,tradejini,tradesmart,upstox,wisdom,zebu,zerodha"
...
while true; do
    log "\nValid brokers:" "$BLUE"
    echo "fivepaisa, fivepaisaxts, aliceblue, angel, arrow, bybit, compositedge, definedge, deltaexchange,"
